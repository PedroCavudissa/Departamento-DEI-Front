...
@Component({
  selector: 'app-comunicado-secretaria',
  standalone: true,
  imports: [BarralateralSecretariaComponent,FormsModule,CommonModule],
  templateUrl: './comunicado-secretaria.component.html',
  styleUrls: ['./comunicado-secretaria.component.css']
})
export class ComunicadoSecretariaComponent implements OnInit {
